...
**Rosario Fase 0 (mapa):** [`.docs/architecture/cat-audio-engine-rosario-map.md`](.docs/architecture/cat-audio-engine-rosario-map.md) — no integrar motor aquí hasta `0.1.x` + piloto Cathedral.
