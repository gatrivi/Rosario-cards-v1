    ...
    <div style={{ position: 'fixed', top: '100px', right: '20px', zIndex: 20 }}>
      ...
      {isOpen && (
        <div style={{
          ...
          <h3 style={{ margin: '0 0 15px', color: 'white', fontSize: '18px' }}>Physics Controls</h3>
          
          {/* Bead Properties */}
          <div style={{ marginBottom: '15px' }}>
            <h4 style={{ color: '#4CAF50', fontSize: '14px', marginBottom: '10px' }}>Bead Properties</h4>
            
            <label style={{ color: 'white', display: 'block', marginBottom: '8px', fontSize: '12px' }}>
              Restitution (Bounce): <strong>{physics.restitution.toFixed(2)}</strong>
              <input 
                type="range" 
                min="0" 
                max="1" 
          ...
          {/* String Properties */}
          <hr style={{ margin: '15px 0', borderColor: '#555', borderWidth: '1px' }} />
          
          <div style={{ marginBottom: '15px' }}>
            <h4 style={{ color: '#4CAF50', fontSize: '14px', marginBottom: '10px' }}>String Properties</h4>
            ...
            <label style={{ color: 'white', display: 'block', marginBottom: '10px', fontSize: '12px' }}>
