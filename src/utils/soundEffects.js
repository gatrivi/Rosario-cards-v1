...
class SoundEffects {
  ...
  playScrollSound() {
    ...
    try {
      ...
      oscillator.frequency.exponentialRampToValueAtTime(baseFreq * 0.7, ctx.currentTime + 0.1);
  ...
  playPageTurnSound() {
    ...
    try {
      ...
      osc1.frequency.exponentialRampToValueAtTime(600 + variation, ctx.currentTime + 0.08);
      ...
      osc2.frequency.exponentialRampToValueAtTime(800 + variation, ctx.currentTime + 0.08);
