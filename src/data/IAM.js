{
  "cantidad_afirmaciones_principales": 7,
  "cantidad_incluyendo_absoluta": 8,
  "afirmaciones": [
    {
      afirmacion: "Yo soy el pan de la vida",
      versos: [
        "Juan 6:35",
        "Juan 6:48",
        "Juan 6:51"
  ...
  "afirmacion_adicional": {
    afirmacion: "La piedra que desecharon los edificadores",
    versos: [
      "Mateo 21:42",
      "Marcos 12:10",
      "Lucas 20:17",
  ...
  "referencias_antiguo_testamento": {
    isaías: [
      {
        verso: "Isaías 7:14",
        descripcion: "Por tanto, el Señor mismo os dará señal: He aquí que la virgen concebirá, y dará a luz un hijo, y llamará su nombre Emanuel."
      },
      {
        verso: "Isaías 9:6",
        descripcion: "Porque un niño nos es nacido, hijo nos es dado, y el principado sobre su hombro; y se llamará su nombre Admirable, Consejero, Dios Fuerte, Padre Eterno, Príncipe de Paz."
      },
      {
        verso: "Isaías 11:1-10",
        descripcion: "Saldrá una vara del tronco de Isaí, y un vástago retoñará de sus raíces. Y reposará sobre él el Espíritu de Jehová; espíritu de sabiduría y de inteligencia, espíritu de consejo y de poder, espíritu de conocimiento y de temor de Jehová."
      },
      {
        verso: "Isaías 53:3-7",
        descripcion: "Despreciado y desechado entre los hombres, varón de dolores, experimentado en quebranto; y como que escondimos de él el rostro, fue menospreciado, y no lo estimamos. Ciertamente llevó él nuestras enfermedades, y sufrió nuestros dolores; y nosotros le tuvimos por azotado, por herido de Dios y abatido."
      }
    ],
    salmos: [
      {
        verso: "Salmos 2:7",
        descripcion: "Yo publicaré el decreto; Jehová me ha dicho: Mi hijo eres tú; Yo te engendré hoy."
      },
      {
        verso: "Salmos 16:10",
        descripcion: "Porque no dejarás mi alma en el Seol, Ni permitirás que tu santo vea corrupción."
      },
      {
        verso: "Salmos 22",
        descripcion: "Detalles de la crucifixión: 'Dios mío, Dios mío, ¿por qué me has desamparado? [...] Han taladrado mis manos y mis pies. Puedo contar todos mis huesos; Ellos me miran y me observan. Repartieron entre sí mis vestidos, Y sobre mi ropa echaron suertes.'"
      },
      {
        verso: "Salmos 110:1",
        descripcion: "Jehová dijo a mi Señor: Siéntate a mi diestra, Hasta que ponga a tus enemigos por estrado de tus pies."
      },
      {
        verso: "Salmos 118:22",
        descripcion: "La piedra que desecharon los edificadores Ha venido a ser cabeza del ángulo."
      }
    ],
    daniel: [
      {
        verso: "Daniel 7:13-14",
        descripcion: "Miraba yo en la visión de la noche, y he aquí con las nubes del cielo venía uno como un hijo de hombre, que vino hasta el Anciano de días, y le hicieron acercarse delante de él. Y le fue dado dominio, gloria y reino, para que todos los pueblos, naciones y lenguas le sirvieran; su dominio es dominio eterno, que nunca pasará, y su reino uno que no será destruido."
      },
      {
        verso: "Daniel 9:24-27",
        descripcion: "Setenta semanas están determinadas sobre tu pueblo y sobre tu santa ciudad, para terminar la prevaricación, y poner fin al pecado, y expiar la iniquidad, para traer la justicia perdurable, y sellar la visión y la profecía, y ungir al Santo de los santos. [...] Y después de las sesenta y dos semanas se quitará la vida al Mesías, mas no por sí; y el pueblo de un príncipe que ha de venir destruirá la ciudad y el santuario; y su fin será con inundación, y hasta el fin de la guerra durarán las devastaciones."
      }
    ]
  }
}