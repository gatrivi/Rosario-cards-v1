...
3. Selecting the **chain before a mystery** => shows **Gloria** and **Fatima**.
4. Selecting the **chain after a mystery** => shows **Our Father**.
5. Selecting the **cross** => shows the **Sign of the Cross**.
